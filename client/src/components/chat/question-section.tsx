...
import { BookKey, Icon, Pencil, RefreshCcw, Trash2 } from 'lucide-react';
...
const QuestionSection = memo(({ messageId, content, onContentChange, isShared, reload }: QuestionSectionProps) => {
    ...
    const actionButtons = useMemo(() => {
        ...
        return (
            <div className="flex space-x-4 opacity-0 group-hover/question:opacity-100">
                ...
                <IconButton onClick={handleReloadClick} tooltipText={('Reload')}>
    ...
    }, [isShared, handleCopy, hasCopied, handleReloadClick, handleEditClick, messageId]);
